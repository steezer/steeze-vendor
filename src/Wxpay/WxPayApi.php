...
use Vendor\Wxpay\Model\WxPayResults;
use Vendor\Wxpay\Model\WxPayReport;
...
class WxPayApi {
	 ...
	 * @param mixed WxPayUnifiedOrder $inputObj
	 * @param int $timeOut
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param mixed WxPayOrderQuery $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayCloseOrder $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayRefund $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 * 
	 * @param \Vendor\Wxpay\Model\WxPayRefundQuery $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	public static function refundQuery($inputObj,$timeOut=6){
		...
		// 检测必填参数
		if(!$inputObj->IsOut_refund_noSet() && !$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet() &&
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayDownloadBill $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function mch_pay($inputObj, $timeOut = 6){
		$url = 'https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers';
		//检测必填参数
		if(!$inputObj->IsOpenidSet()) {
			throw new WxPayException("付款接口中，缺少必填参数用户openid！");
		}else if(!$inputObj->IsAmountSet()){
			throw new WxPayException("付款接口中，缺少必填参数金额amount！");
		}else if(!$inputObj->IsPartner_trade_noSet()){
			throw new WxPayException("付款接口中，缺少必填参数商户订单号partner_trade_no！");
		}else if(!$inputObj->IsDescSet()){
			throw new WxPayException("付款接口中，缺少必填参数企业付款描述信息desc！");
		}
		...
		$inputObj->setSpbill_create_ip(self::getIP());
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayMicroPay $inputObj
	 * @param int $timeOut
	 */
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayReverse $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 */
	 ...
	 * 生成二维码规则,模式一生成支付二维码
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayBizPayUrl $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 * 减小二维码数据量，提升扫描速度和精确度。
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 * @param \Vendor\Wxpay\Model\WxPayShortUrl $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
