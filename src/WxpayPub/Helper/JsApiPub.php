...
class JsApiPub extends CommonUtilPub{
	...
	function getOpenid(){
		...
		$ch=curl_init();
		//设置超时
		curl_setopt($ch,WxPayConfPub::$CURL_TIMEOUT,$this->curl_timeout);
	 ...
	 * 	作用：设置jsapi的参数
	 */
	public function getParameters($isJson=true){
		...
		$this->parameters=$isJson ? json_encode($jsApiObj) : $jsApiObj;
