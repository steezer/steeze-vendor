...
if (!class_exists('QRcode', false)) {
	...
	if (!function_exists('str_split')) {
    	 ...
    	 * @return mixed  If the optional split_length  parameter is specified, the returned array will be broken down into chunks with each being split_length  in length, otherwise each chunk will be one character in length. FALSE is returned if split_length is less than 1. If the split_length length exceeds the length of string , the entire string is returned as the first (and only) array element.
    	 */
	...
	class QRcode {
		...
		/**
		 * @desc barcode array to be returned which is readable by TCPDF
		 * @access protected
		 */
		protected $barcode_array = array();

		/**
		 * @desc QR code version. Size of QRcode is defined as version. Version is from 1 to 40. Version 1 is 21*21 matrix. And 4 modules increases whenever 1 version increases. So version 40 is 177*177 matrix.
		 * @access protected
		 */
		protected $version = 0;

		/**
		 * @desc Levels of error correction. See definitions for possible values.
		 * @access protected
		 */
		...
		/**
		 * @desc true the input string will be converted to uppercase
		 * @access protected
		 */
		protected $casesensitive = true;

		/**
		 * @desc structured QR code (not supported yet)
		 * @access protected
		 */
		...
		/**
		 * @desc X position of bit
		 * @access protected
		 */
		protected $x;

		/**
		 * @desc Y position of bit
		 * @access protected
		 */
		protected $y;
		...
		/**
		 * @desc alphabet-numeric convesion table
		 * @access protected
		 */
		...
		/**
		 * @desc array Table of the capacity of symbols
		...
		/**
		 * @desc array Table of the error correction code (Reed-Solomon block)
		...
		/**
		 * @desc array Positions of alignment patterns.
		...
		/**
		 * @desc array Version information pattern (BCH coded).
		 ...
		 * @param array $at x,y position
		 * @return mixed value at specified position
		 */
		 ...
		 * @return mixed array of x,y coordinates
		 */
		 ...
		 * @return mixed 0 in case of success, -1 in case of error
		 */
		 ...
		 * @param int $version version
		 * @return mixed BCH encoded version information pattern
		 */
		 ...
		 * @param array $mask
		 * @param int $level error correction level
		 * @return mixed BCH encoded format information pattern
		 */
